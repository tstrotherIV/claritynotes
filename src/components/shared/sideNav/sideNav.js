      ...
      <Navbar color="light" light expand="false" color="white">
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="mr-auto" navbar>
            ...
            <NavItem>
              <NavLink href="/history_of_legal_pg_1">History of Legal</NavLink>
            </NavItem>
            <NavItem>
            ...
            <NavItem>
              <NavLink href="/parent_knowledge_pg_1">Parent Knowledge</NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="/cognitive_skills_pg_1">Cognitive Skills</NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="/material_resources_pg_1">Material Resources</NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="/behavioral_observations_and_testing_conditions_pg_1">Behavioral Observations and Testing</NavLink>
            </NavItem>
            <NavItem>
