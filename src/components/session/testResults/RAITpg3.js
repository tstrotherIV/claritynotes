        ...
        <div id="page-container">
          ...
          <div className="ml-5 mr-5 mt-3">
           ...
           <div className="col-6 text-white">
                ...
                <p> Assesses both crystallized and fluid aspects of quantitative reasoning using two subtests: Quantitative Knowledge and Quantitative Reasoning.
                </p>
                <label><h4>Enter QII Score:</h4></label> 
                <input 
